    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card-header"><h5>Hello, Sir/Ma'aM</h5>
                     <a href="{{url('/volunteer/index')}}" class="btn btn-success btn-sm"><i class="material-icons">View Personal Details</i></a>
                </div>
                <div class="card-body">
                    <h3>Volunteer</h3>
                    <form method="post" action="{{route('volunteer_store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="">Oraganization Name* </label>
                                    <input type="text" class="form-control @error('organization') is-invalid @enderror" name="organization" placeholder="Eg: XYZ Pvt. Ltd" value="">
                                    @error('organization')
                        ...
                        <div class="form-group">
                            <div class="row ">
                                <div class="col-md-6">
                                    ...
                                    <a href="{{url('/education/create')}}" class="btn btn-success btn-sm"><i class="material-icons">Skip</i></a>
